...
urlpatterns =[
    ...
    path('accounts/login/registration/', registration, name="registration"),
    ...
    path('reset/done/',auth_view.PasswordResetCompleteView.as_view(template_name='registration/password_reset_complete.html'),name="password_reset_complete"),
    path('accounts/logout/',TemplateView.as_view(template_name="logged_out.html")),
